...
%\begin{figure}[H]
%    \centerline{\includegraphics[width=0.45\textwidth]{d_CONelectrodo_SINnotch_aire.jpg}}
%    \caption{D.E. I sin tercer electrodo, sin filtro notch, manos en el aire}
%    \end{figure}

%\begin{figure}[H]
%    \centerline{\includegraphics[width=0.45\textwidth]{d_CONelectrodo_CONnotch.jpeg}}
